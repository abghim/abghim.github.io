...
title: On uv
---
uv, the next-generation package manager. I first tried it out a few days ago, mostly out of frustration regarding pip. I made the mistake (or rather, a dependency made a mistake) of downloading homebrew python, and pip refused to update packages due to an external installation.
